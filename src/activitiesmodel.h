...
class QYOUTUBESHARED_EXPORT ActivitiesModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QYouTube::ActivitiesRequest::Status status READ status NOTIFY statusChanged)
    Q_PROPERTY(QYouTube::ActivitiesRequest::Error error READ error NOTIFY statusChanged)
