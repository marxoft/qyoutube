...
#ifndef PLAYLISTITEMSREQUEST_H
#define PLAYLISTITEMSREQUEST_H

#include "request.h"

namespace QYouTube {

class QYOUTUBESHARED_EXPORT PlaylistItemsRequest : public Request
{
    Q_OBJECT
    
public:
    explicit PlaylistItemsRequest(QObject *parent = 0);
...
private:
    Q_DISABLE_COPY(PlaylistItemsRequest)
};

}

#endif // PLAYLISTITEMSREQUEST_H
