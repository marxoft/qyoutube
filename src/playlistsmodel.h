...
class QYOUTUBESHARED_EXPORT PlaylistsModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QYouTube::PlaylistsRequest::Status status READ status NOTIFY statusChanged)
    Q_PROPERTY(QYouTube::PlaylistsRequest::Error error READ error NOTIFY statusChanged)
